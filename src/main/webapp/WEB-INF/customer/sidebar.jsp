...
<div class="sidebar">
    ...
    <% } else { %>
        <a href="${pageContext.request.contextPath}/dashboard" class="menu-item <%= currentPage.equals("/dashboard") ? "active" : "" %>">
            <i class="fa-solid fa-gauge"></i> Dashboard
        </a>
        <a href="${pageContext.request.contextPath}/menu" class="menu-item <%= currentPage.equals("/menu") ? "active" : "" %>">
            <i class="fa-solid fa-utensils"></i> Menu
        </a>
        <a href="${pageContext.request.contextPath}/booking" class="menu-item <%= currentPage.equals("/booking") ? "active" : "" %>">
            <i class="fa-solid fa-calendar-days"></i> Book a Table
        </a>
        <a href="${pageContext.request.contextPath}/history" class="menu-item <%= currentPage.equals("/history") ? "active" : "" %>">
            <i class="fa-solid fa-clock-rotate-left"></i> History
        </a>
        <a href="${pageContext.request.contextPath}/booking/cancel" class="menu-item <%= currentPage.equals("/booking/cancel") ? "active" : "" %>">
            <i class="fa-solid fa-ban"></i> Cancel Booking
        </a>
        <a href="${pageContext.request.contextPath}/order/track" class="menu-item <%= currentPage.equals("/order/track") ? "active" : "" %>">
            <i class="fa-solid fa-bowl-food"></i> Order Status
        </a>
        <a href="${pageContext.request.contextPath}/wallet" class="menu-item <%= currentPage.equals("/wallet") ? "active" : "" %>">
